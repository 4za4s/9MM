...
/**
 * Creates a drawing of the background. This drawing has to be added to a panel
 * to be viewed
 */
class Background extends JLayeredPane {
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.drawLine(gap * 3 + lineWidth / 2, 0 + lineWidth / 2, gap * 3 + lineWidth / 2, gap * 2 + lineWidth / 2); // top
                                                                                                                   // line
        g2.drawLine(gap * 3 + lineWidth / 2, gap * 4 + lineWidth / 2, gap * 3 + lineWidth / 2, gap * 6 + lineWidth / 2); // bottom
                                                                                                                         // line
        g2.drawLine(lineWidth / 2, gap * 3 + lineWidth / 2, gap * 2 + lineWidth / 2, gap * 3 + lineWidth / 2); // left
                                                                                                               // line
        g2.drawLine(gap * 4 + lineWidth / 2, gap * 3 + lineWidth / 2, gap * 6 + lineWidth / 2, gap * 3 + lineWidth / 2); // right
                                                                                                                         // line
    }
